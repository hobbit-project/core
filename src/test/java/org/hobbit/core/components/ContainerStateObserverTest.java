...
public class ContainerStateObserverTest implements ContainerStateObserver {
    ...
    public static Collection<Object[]> data() {
        ...
        testConfigs.add(new Object[] { new AbstractEvaluationStorage() {
            @Override
            public void receiveExpectedResponseData(String taskId, long timestamp, InputStream data) {
            }

            @Override
            public void receiveResponseData(String taskId, long timestamp, InputStream data) {
            }
